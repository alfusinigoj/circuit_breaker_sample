...
namespace Fortune_Teller_UI.Services
{
    ...
    public class FortuneService :  IFortuneService
    {
        ...
        private const string RANDOM_FORTUNE_URL = "https://fortuneService-aj/api/fortunes/random";
        private const string FORTUNES_URL = "https://fortuneService-aj/api/fortunes";
