...
namespace Fortune_Teller_UI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHystrixCommand<FortuneServiceCommand>("FortuneService-AJ", Configuration);
            ...
            services.AddHystrixCollapser<IFortuneServiceCollapser, FortuneServiceCollapser>("FortuneServiceAJCollapser", Configuration);
